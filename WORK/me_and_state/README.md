...
Markdown-страницы в `WEB` дают читателю короткий вход в тему и ссылки на материалы подраздела.

## Результат

Раздел можно использовать как готовый блок TeenBook: у него есть рабочие данные, диаграммы, Wikidata-выгрузки и web-страницы в Markdown-формате.
